...
s1 = np.load('sin/test_list1.npy')
s2 = np.load('sin_adaptive_alpha/test_list1.npy')
c1 = np.load('cos/test_list1.npy')
c2 = np.load('cos_adaptive_alpha/test_list1.npy')
x_s1 = len(s1)
x_s2 = len(s2)
x_c1 = len(c1)
x_c2 = len(c2)
...
plt.title("CNN for different actavation function in CIFAR10")
